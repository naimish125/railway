...
List<RailwayModel> RailwayModelFromJson(String str) => List<RailwayModel>.from(json.decode(str).map((x) => RailwayModel.fromJson(x)));

String RailwayModelToJson(List<RailwayModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
